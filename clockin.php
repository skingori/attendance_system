...
if(isset($_POST['clockin'])) {
    ...
    $check_id = $con->query("SELECT student_id FROM login_table WHERE student_id='$employeenumber'");
    ...
    if(empty($employeenumber)) {
        ...
        if(empty($employeenumber)) {
            ...
            echo "<font color='red'>ENTER STUDENT NUMBER</font><br/>";
            ?>
       ...
       if($count==0){
           ...
           echo "<font color='red'>STUDENT ID NOT FOUND</font><br/>";
            ?>
            <meta content="0;index.php?action=home" http-equiv="refresh" />
