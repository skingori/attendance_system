...
if(isset($_POST['update']))
{
    ...
    if(empty($student_name) || empty($student_email )) {
        ...
        //updating the table
        $result = mysqli_query($con, "UPDATE login_table SET student_name='$student_name',student_email='$student_email',student_class='$student_class' ,student_course='$student_course' WHERE login_id=$id");
...
$result = mysqli_query($con, "SELECT * FROM login_table WHERE login_id=$id");
...
<form action="" method="post">
    ...
    <div class="form-group">
        <input type="text" name="student_name" value="<?php echo $student_name;?>" required class="form-control" placeholder="Name">
    </div>
    <div class="form-group">
        <input type="email" name="student_email" required value="<?php echo $student_email;?>" class="form-control" placeholder="Email">
    </div>
    <div class="form-group">
        <input type="text" name="student_class" required value="<?php echo $student_class;?>" class="form-control" placeholder="Class">
    </div>
    <div class="form-group">
        <input type="text" name="student_course" required value="<?php echo $student_course;?>" class="form-control" placeholder="Course">
    </div>
    <!--</div>-->
    <div class="footer">

        <button type="submit" name="update" class="btn bg-olive">Update Student</button>
    </div>
</form>
