...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            $result = mysqli_query($con, "SELECT * FROM user_attendance ORDER BY attendance_id DESC"); // using mysqli_query instead
            ?>
            ...
            <table  border=0 cellpadding="1" cellspacing="1" id="" width="100%" class="table table-hover table-striped">
                ...
                while($res = mysqli_fetch_array($result)) {
                    ...
                    echo "<td class=''>".$res['attendance_id']."</td>";
                    ...
                    echo "<td><a href=\"delete.php?aid=$res[attendance_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                }
                ?>
                </tbody>
