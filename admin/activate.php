...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            $result = mysqli_query($con, "SELECT * FROM login_table ORDER BY login_id DESC"); // using mysqli_query instead
            ?>

            <table  border=0 cellpadding="1" cellspacing="1" id="" width="100%" class="table table-hover table-striped table-bordered">
                ...
                while($res = mysqli_fetch_array($result)) {
                    ...
                    echo "<td class='active'>".$res['login_username']."</td>";
                    echo "<td>".$res['login_rank']."</td>";
                    echo "<td>".$res['login_status']."</td>";
                    echo "<td><a href=\"ac_.php?id=$res[login_id]\">Activate</a> | <a href=\"deac_.php?id=$res[login_id]\" onClick=\"return confirm('Are you sure you want to deactivate?')\">Deactivate</a></td>";
                }
                ?>
            </table>
