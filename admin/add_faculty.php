...
if(isset($_POST['register'])) {
    ...
    $check_email = $con->query("SELECT * FROM faculty WHERE faculty_id='$faculty_id'");
    $count=$check_email->num_rows;

    if ($count==0) {

        $query = "INSERT INTO faculty(faculty_name) VALUES('$faculty_name_')";
        ...
        <section class="content">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="faculty_name" required class="form-control" placeholder="Faculty Name"/>
                </div>

                <!--</div>-->
                <div class="footer">

                    <button type="submit" name="register" class="btn bg-olive">Add Faculty</button>
                </div>
            </form>
            <!--********************Add content here *******************-->
        </section><!-- /.content -->
